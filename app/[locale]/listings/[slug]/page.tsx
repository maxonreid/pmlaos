...
export default async function ListingDetailPage({
  ...
  const amenityLabels: Record<string, { label: string; icon: string }> = {
    ...
    kitchen: { label: t('listing.amenityKitchen'), icon: '🍳' },
    living_room: { label: t('listing.amenityLivingRoom'), icon: '🛋️' },
    refrigerator: { label: t('listing.amenityRefrigerator'), icon: '🧊' },
    microwave: { label: t('listing.amenityMicrowave'), icon: '🍱' },
